...
export default function TakeawayStoreStockPage(): JSX.Element {
  ...
  const mutation = useMutation({
    mutationFn: () => {
      if (!writesEnabled) throw new Error("การปรับสต๊อกยังถูกล็อกในช่วง Dark launch");
