...
Revision ID: p5platform0009
Revises: p4platform0008
"""
...
revision: str = "p5platform0009"
down_revision: Union[str, None] = "p4platform0008"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("credential_version > 0", name="ck_platform_operators_credential_version_positive"),
        sa.CheckConstraint("failed_login_attempts >= 0", name="ck_platform_operators_failed_attempts_nonnegative"),
