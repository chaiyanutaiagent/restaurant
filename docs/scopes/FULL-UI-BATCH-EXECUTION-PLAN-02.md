...
|---|---|---|---|
| A | WP55–WP58 | Retail POS R01–R10: foundation, scan-first sale, exceptions, payment/receipt, Hold/Return/Shift, offline and Counter readiness | WP55 authenticated Retail checkpoint passed; WP56 software UAT, independent QA and rollback passed, physical UAT pending; WP57–WP58 planned |
