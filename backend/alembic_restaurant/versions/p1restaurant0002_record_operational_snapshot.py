"""record restaurant operational snapshot rehearsal

Revision ID: p1restaurant0002
Revises: p1restaurant0001
...
revision: str = "p1restaurant0002"
down_revision: Union[str, None] = "p1restaurant0001"
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        "'restaurant_operational_snapshot', false)"
    )
