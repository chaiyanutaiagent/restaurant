"""initialize platform database boundary

Revision ID: p1platform0001
Revises:
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        "(boundary_name, schema_contract_version) VALUES ('platform_core', 1)"
    )
