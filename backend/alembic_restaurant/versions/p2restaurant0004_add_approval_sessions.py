"""add Restaurant approval usages and operational limits

Revision ID: p2restaurant0004
Revises: p1restaurant0003
...
revision: str = "p2restaurant0004"
down_revision: Union[str, None] = "p1restaurant0003"
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        "WHERE boundary_name = 'restaurant'"
    )
